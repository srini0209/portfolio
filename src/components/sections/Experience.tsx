...
const EXPERIENCES = [
  {
    ...
    company: "Creosen Services Private Limited",
      ...
      <div className="container mx-auto px-4 ">
        ...
        >
          ...
          <p className={`text-muted-foreground max-w-2xl mx-auto `}>
            A journey through my professional development, building scalable
            applications and growing technical expertise
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          {EXPERIENCES.map((experience, index) => (
            <motion.div
              ...
              className="relative mb-8 floating-hexagon"
            >
              {/* Timeline line */}
